...
/* package calcParser-himadriali-0.1.0.0 */
#ifndef VERSION_calcParser_himadriali
#define VERSION_calcParser_himadriali "0.1.0.0"
#endif /* VERSION_calcParser_himadriali */
#ifndef MIN_VERSION_calcParser_himadriali
#define MIN_VERSION_calcParser_himadriali(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_calcParser_himadriali */
...
#define CURRENT_PACKAGE_KEY "calcParser-himadriali-0.1.0.0-inplace"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "calcParser-himadriali-0.1.0.0-inplace"
